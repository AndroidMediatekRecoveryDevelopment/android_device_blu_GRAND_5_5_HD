...
LOCAL_PATH := device/blu/GRAND_5_5_HD
...
BOARD_MKBOOTIMG_ARGS  := --kernel_offset 0x00008000 --ramdisk_offset 0x04000000 --tags_offset 0x0e000000 --board BLU_G030U_V16_G
TARGET_PREBUILT_KERNEL := device/blu/GRAND_5_5_HD/kernel
...
# RECOVERY
TARGET_RECOVERY_FSTAB := device/blu/GRAND_5_5_HD/twrp.fstab


# PARTTIONS
# We need the partitions size in decimal
# Use cat proc/partitions via adb, then block size * 1024
# This is the partitions of blu ROM, system size is bigger than Android One ROM
